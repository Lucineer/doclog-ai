...
.card h3{color:#3B82F6;margin-top:0}
</style></head><body><div class="hero"><div>
      ...
      <h1>📋 DocLog</h1><p>Living documentation that watches your codebase evolve. After 6 months, this repo knows your API better than any new hire.</p><a href="/app" class="btn">Open Docs</a></div></div>
